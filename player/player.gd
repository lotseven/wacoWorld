...
const MASS = 80
const SNAP_DISTANCE = 45.0
const MAGNET_FORCE = 500000.0
# cam stuff
var camOffset = 600
var camOffSaved = 600
...
#func updateMagMovement():
	#activeMagnetList = $magManager.selectables
...
func magnetMovement(delta):
	if flingMag and wantsToPull:
		...
		if dist < SNAP_DISTANCE: # snaps position to the magnet if you click and get real close
			...
			var magnetic_force = direction * MAGNET_FORCE
			var acceleration = magnetic_force / MASS
